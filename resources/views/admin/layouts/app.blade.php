        ...
        <div class="tb-right">
            ...
            <div class="notif-wrap" id="notifWrap">
                ...
                <div class="notif-dropdown" id="notifDropdown">
                    ...
                    <a href="{{ route('admin.budget-requests') }}" class="nd-item" onclick="closeNotif()">
                        <div class="nd-icon" style="background:var(--blue)">
                            <svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
                        </div>
                        <div class="nd-body">
                            <div class="nd-text">Budget Requests</div>
...
<div class="cmd-ov" id="cmdOverlay" onclick="if(event.target===this)closeCmd()">
    <div class="cmd-box">
        ...
        <div class="cmd-results" id="cmdResults">
            ...
            <a class="cmd-item" href="{{ route('admin.budget-requests') }}" onclick="closeCmd()">
                <div class="cmd-item-icon"><svg viewBox="0 0 24 24"><rect x="1" y="4" width="22" height="16" rx="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg></div>
                <div class="cmd-item-body"><div class="cmd-item-text">Budget Requests</div><div class="cmd-item-sub">Pending chapter budget approvals</div></div>
            </a>
