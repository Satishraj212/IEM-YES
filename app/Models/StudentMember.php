...
class StudentMember extends Authenticatable implements MustVerifyEmail
{
    use HasFactory, Notifiable, SoftDeletes;

    /**
     * Points to the shared `users` table so auth continues to work
     * seamlessly alongside any existing User model.
     */
    protected $table = 'users';

    protected $fillable = [
        'branch_id', 'member_id', 'name', 'email', 'password',
        'role', 'status', 'faculty', 'phone', 'student_id',
        'avatar_path', 'joined_date', 'cpd_points', 'volunteer_hours',
        'current_role',
    ];
